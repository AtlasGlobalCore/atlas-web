...
/**
 * Auth endpoints — login and logout removed (handled by Supabase Auth).
...
/**
 * Clear auth tokens from localStorage (client-side only, no backend call).
 * Used after Supabase signOut() completes.
 */
